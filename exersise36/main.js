...
var make_shirt = function (size, message) {
    console.log("size:".concat(size, ", messege'").concat(message, "' "));
};
//call the function
// agar hamay ye variable may karna ho tho
var size = "xl";
var messege = "inshallah sheikh yahya khan will future billionarie";
